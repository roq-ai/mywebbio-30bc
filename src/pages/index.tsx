...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Mywebbio`}</title>

        <meta
          name="description"
          content="Welcome to Mywebbio, your AI-based tool for analyzing website performance and suggesting UI UX changes for optimal results."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1625314887424-9f190599bd56?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSXxlbnwwfHx8fDE2OTA2NDYxOTR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mrsunburnt?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Xu Haiwei`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Mywebbio, your AI-based tool for analyzing website performance and suggesting UI UX changes for optimal results.`}
            </Text>
            <Box
